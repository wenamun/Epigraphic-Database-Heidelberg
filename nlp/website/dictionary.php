...
function printHdNumbers($lemma,$c){
    ...
    foreach ($rs as $document) {
       print "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./inscription.php?hd_nr=" . $document->hd_nr . "&token_id=" . $document->token_id . "\" style=\"color: #1f8dd6;font-weight: bold;text-decoration:none\" target=\"_blank\">" . $document->hd_nr . "</a>, " . $document->token_id . "<br>\n";
   }
}
